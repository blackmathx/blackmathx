		...
		<>
			...
			<form className="max-w-sm mx-auto mt-16 p-8 bg-white rounded shadow space-y-6">
				...
				<div className="flex gap-4">
					<button type="submit" formAction={login} className="flex-1 bg-slate-700 hover:bg-slate-500 text-white font-semibold py-2 px-4 rounded transition-colors">Sign in</button>
